...
| 预测对象 | Accuracy | Macro-F1 | 价值解读 |
|:------:|:------:|:------:|------|
| 故障大类 | 92.40% | 92.42% | 能较稳定地区分机械、电气、仪表、工艺、安全等主要故障类型 |
| 停机风险等级 | 85.84% | 86.09% | 可用于识别 P0/P1 高风险工单，并为优先级排序提供模型依据 |
| 处理部门 | 90.23% | 90.19% | 可为维修、自动化、工艺、安全等部门分派提供候选建议 |
| 三任务综合 | - | 89.57% | 整体上能够支撑“故障识别 + 风险判断 + 部门推荐”的联合预测流程 |
